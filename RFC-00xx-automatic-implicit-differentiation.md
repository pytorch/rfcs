...
A practical implementation can pre-compute an LU decomposition of $\partial_{1}G(x,\theta)$ or if, and only if, $\partial_{1}G(x,\theta)$ is positive and semi-definite, a Cholesky decomposition.
